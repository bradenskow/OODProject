...
namespace Nutrition.NutritionTracker
{
    ...
    {
        private static Breakfast instance;
        private List<Food> breakfastFood = new List<Food>();
        private List<Drink> breakfastDrinks = new List<Drink>();
        ...
        private int totalCalories
        {
            ...
            {
                int totalcalories = 0;
                foreach (Food food in breakfastFood)
                {
                    totalcalories += food.Calories;
                }

                foreach (Drink drink in breakfastDrinks)
                {
